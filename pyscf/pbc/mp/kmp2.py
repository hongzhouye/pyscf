...
def _init_mp_df_eris(mp, mo_coeff=None, Lov=None):
    ...
    Returns:
        Lov (numpy.ndarray or H5 group) -- 3-center DF ints, with shape
    ...
    if Lov is None:
        ...
        log.error('Input Lov must be np.ndarray or h5py.Group.')
        raise TypeError
...
class _DFMP2ERIS_OUTCORE(_DFMP2ERIS_INCORE):
    ...
    def _common_init_(self, mp, mo_coeff=None):
        ...
        dtype = np.double if gamma_point(self.kpts) else np.complex128
