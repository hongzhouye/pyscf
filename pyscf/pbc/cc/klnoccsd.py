...
from pyscf.cc.lnoccsd import (LNOCCSD, MODIFIED_CCSD, MODIFIED_DFCCSD, _ChemistsERIs,
                              impurity_solve, get_maskact, _cp)
from pyscf.pbc.cc.klno import KLNO
from pyscf.pbc.cc.klno_helper import K2SDF, zdotCNtoR, zdotNNtoR, k2s_aoint
...
''' Beginning of modification of PySCF's (DF)CCSD class for K2S (DF)CCSD

    These functions are modified from pyscf.cc and parallel those in lno.cc.ccsd.
...
if __name__ == '__main__':
    ...
    from pyscf.pbc.cc.klno_helper import k2s_scf, k2s_aoint
    from pyscf.pbc.cc.klno_helper import sort_orb_by_cell
