...
''' LNO-RCCSD (both molecule and pbc w/ Gamma-point BZ sampling)
    ...
    if nactmo > max_las_size_ccsd:
        ...
        if ccsd_t:
            if nactmo > max_las_size_ccsd_t:
                ...
                from pyscf.cc.lnoccsd_t import kernel as CCSD_T
...
# LNO with PM localized orbitals
    ...
    threshs = np.asarray([3e-5,1e-5,3e-6,1e-6,3e-7,1e-7])
