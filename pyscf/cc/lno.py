...
''' Generic framework for local natural orbital (LNO)-based methods. This code can be used
    to implement LNO-based local correlation approximation to many correlated wavefunction
    methods. See `lnoccsd.py` for the implementation of LNO-CCSD as an example.
...
from pyscf.cc.make_lno_rdm1 import make_lo_rdm1_occ, make_lo_rdm1_vir
